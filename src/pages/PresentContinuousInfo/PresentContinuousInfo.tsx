...
import simplePresentContent, { Lang } from "../../locales/PresentContinuousContent";
import "./PresentContinuousInfo.css";
  ...
  return (
    <section className="info-container">
      ...
      <div className="content">
        ...
        <button className="start-quiz" onClick={() => navigate("/presentContinuousquiz")}>
          {content.buttonText}
        </button>
      </div>
    </section>
